	...
	# Combine DNP3 addrs as a 'flow ID'
	slli t2, t0, 16		# (src<<16)
	or t3, t2, t1		#           + dst
	slli t2, t1, 16		# (dst<<16)
	or t4, t2, t0		#           + src
	
	sd t4, 0(a2)		# store dst:src as the source output
	sd t3, 0(a3)		# store src:dst as the destination output
